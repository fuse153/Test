		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="tab-content">
					...
					<form method="post" action="purchase.ItemShop">
							...
							<tbody>
								<tr>
									...
									<td><label><input type="radio"
											name="util_kind" value="노블레스 자유 1일 이용권 , 2400" >노블레스 자유 <strong class="day"
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 자유 3일 이용권 , 4900">노블레스
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 자유 30일 이용권 , 24900">노블레스 자유 <strong class="day"
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 자유 60일 이용권 , 39900">노블레스 자유 <strong class="day"
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 자유 90일 이용권 , 49900">노블레스 자유 <strong class="day"
								...
								<tr>
									<td bgcolor="#ffffcc"><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 1일 이용권 , 1500">로맨스 장르전용 <strong
								...
								<tr>
									<td  bgcolor="#ffffcc"><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 3일 이용권 , 3000">로맨스 장르전용 <strong
								...
								<tr>
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 30일 이용권 , 17000">로맨스 장르전용 <strong
								...
								<tr>
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 60일 이용권 , 23000">로맨스 장르전용 <strong
											style="width: 34px;">60</strong>일 이용권</label></td>
								...
								<tr >
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 90일 이용권 , 27000">로맨스 장르전용 <strong
											style="width: 34px;">90</strong>일 이용권</label></td>
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 야간 1일 이용권 , 1200">노블레스 야간 <strong
											class="day" style="width: 34px;">1</strong>일 이용권</label></td>
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 야간 30일 이용권 , 13000">노블레스 야간 <strong class="day"
											style="width: 34px;">30</strong>일 이용권</label></td>
								...
								<tr>
									...
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 청소년 자유 1일 이용권 , 1500">노블레스 청소년 자유 <strong class="day"
											style="width: 34px;">1</strong>일 이용권</label></td>
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 청소년 자유 30일 이용권 , 17000">노블레스 청소년 자유 <strong class="day"
											style="width: 34px;">30</strong>일 이용권</label></td>
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 청소년 자유 60일 이용권 , 23000">노블레스 청소년 자유 <strong class="day"
											style="width: 34px;">60</strong>일 이용권</label></td>
								...
								<tr>
									<td ><label><input type="radio"
											name="util_kind" value="노블레스 청소년 자유 90일 이용권 , 27000">노블레스 청소년 자유 <strong class="day"
											style="width: 34px;">90</strong>일 이용권</label></td>
								...
								<tr>
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 청소년 , 1200">로맨스 장르전용 청소년 <strong
											class="day" style="width: 34px;">1</strong>일 이용권</label></td>
								...
								<tr>
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 청소년 30일 이용권 , 13000">로맨스 장르전용 청소년 <strong
											class="day" style="width: 34px;">30</strong>일 이용권</label></td>
								...
								<tr>
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 청소년 60일 이용권 , 19900">로맨스 장르전용 청소년 <strong
								...
								<!-- ex ) int a = 30; -->
									<td bgcolor="#ffffcc" ><label><input type="radio"
											name="util_kind" value="로맨스 장르전용 청소년 90일 이용권 , 25000">로맨스 장르전용 청소년<strong
